...
BOT_NAME = "فناوری، هوش مصنوعی و ارز دیجیتال"

# دستورِ موضوعی به سردبیرِ AI: این ربات فقط همین حوزه را پوشش می‌دهد.
TOPIC_HINT = (
    "This channel covers TECHNOLOGY, ARTIFICIAL INTELLIGENCE and CRYPTOCURRENCY: new "
    "gadgets and devices, smartphones, software and apps, AI models and tools, startups, "
    "the internet and online services (including filtering/VPN news relevant to Iran), "
    "science and the tech industry, blockchain, bitcoin and other cryptocurrencies, and "
    "crypto/market news. Pick the most important and interesting items in this topic; "
    "treat clearly off-topic items (general politics, sports, celebrity/cinema) as soft "
    "and skip them, and skip low-value filler like shopping guides or trivial rumors."
)
...
RSS_FEEDS = [
    "https://www.zoomit.ir/feed/",   # زومیت — فناوری/هوش‌مصنوعی/ارز دیجیتال
]
SOURCE_NAMES = {
    "https://www.zoomit.ir/feed/": "زومیت",
}
